...
<template>
	<section id="app-store-menu">
		<div class="app-store-menu_search">
			<img
		...
		<menu>
			...
			>
				...
				>
				<span>{{ opt.label }}</span>
				<span v-if="opt.subLabel" class="app-store-menu_subLabel">{{ opt.subLabel }}</span>
			</li>
		</menu>
		<div class="app-store-menu_footer">
