...
export const PROJECTS: Projects = [
	...
	},
	{
		...
		items: [
			...
			{
				name: '2020 Portfolio',
				description: 'Original Portfolio Website created after graduating from trade school, 2020',
				...
				links: [
					['Website', 'https://lone-do.github.io/2020-portfolio/'],
					['Github', 'https://github.com/lone-do/2020-portfolio/'],
				],
			},
		],
	},
